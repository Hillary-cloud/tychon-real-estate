                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label class="" for=""><h3><strong>Cover Photo</strong></h3></label>
                                            ...
                                            <img src="/property_main_images/{{$property->main_image}}" alt="" style="display: block" width="250px" class="mt-2 img-responsive">
                                    ...
                                    <div class="form-group">
                                        <label class="" for=""><h3><strong>More Photos</strong></h3></label><br>
                                            ...
                                            @foreach ($images as $image)
                                                <img src="/property_sub_images/{{$image->image}}" width="250px" class="img-responsive mt-2" alt="">
